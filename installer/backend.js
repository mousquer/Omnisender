...
app.post('/setup', async (req, res) => {
    ...
    try {
        ...
        if (!req.body.skipSmtp) {
            await prisma.systemConfig.upsert({ where: { key: 'smtpHost' }, update: { value: req.body.smtpHost }, create: { key: 'smtpHost', value: req.body.smtpHost } });
            await prisma.systemConfig.upsert({ where: { key: 'smtpPort' }, update: { value: req.body.smtpPort }, create: { key: 'smtpPort', value: req.body.smtpPort } });
            await prisma.systemConfig.upsert({ where: { key: 'smtpUser' }, update: { value: req.body.smtpUser }, create: { key: 'smtpUser', value: req.body.smtpUser } });
            await prisma.systemConfig.upsert({ where: { key: 'smtpPass' }, update: { value: req.body.smtpPass }, create: { key: 'smtpPass', value: req.body.smtpPass } });
            await loadConfig();
        }
...
app.post('/api/send', (req, res) => {
    upload.single('image')(req, res, async function (err) {
        ...
        // Blindagem no Back-end: Retorna erro se nenhum sistema estiver configurado
        ...
        // Retorna para a aba 'send' após o disparo
