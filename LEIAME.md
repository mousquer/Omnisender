...
O objetivo do projeto é facilitar e democratizar a comunicação multicanal. Sem a necessidade de assinar serviços de terceiros para funções simples, o OmniSender permite que você centralize seus envios de forma gratuita e direta. A ferramenta foi desenhada para ser acessível, rodando perfeitamente tanto em ambientes Windows quanto Linux.
...
* **Windows/Linux/AWS:** Instale em apenas alguns minutos no ambiente que você mais está familiarizado (Pode rodar até localmente).
...
* **Experiência do Usuário (UX):** Interface limpa com contador de caracteres em tempo real e modal de confirmação de segurança para evitar o envio acidental de textos longos.
...
## Como Instalar
Para rodar o projeto localmente, clone o repositório e execute os comandos abaixo na raiz do diretório:
...
Nossos próximos passos de desenvolvimento incluem:
...
* **Controle Ativo:** Capacidade de excluir mensagens já enviadas diretamente pelo painel do OmniSender.
